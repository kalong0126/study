...
/**
 * 「长童话」模式专用的一篇：按家长的《童话故事提示词》格式来 ——
 * 第一行《标题》，正文 8 段，无 ASCII 字符。
 * 用它是为了让**前端**的童话测试有稳定素材：一屏 5 行装不下，
 * 才能真的验证「滚动阅读」而不是「一篇刚好一屏、什么都没滚」。
 */
const LONG_STORY = [
  "《会飞的棉被去旅行》",
  "",
  "夜里，小满的被角偷偷翘了起来。被子里藏着一百只小风铃，它们说：“我们想去看看外面的世界，可以吗？”小满揉揉眼睛，抱住被子说：“那你们要记得回来呀。”",
  "棉被抖了抖，像一只胖乎乎的云朵鸟，“呼”地飞出了窗户。它先飞过屋顶，把邻居家打呼噜的小狗吓得汪汪叫，又把晾衣绳上的袜子套在自己身上当翅膀。",
  "它飞到月亮下面，月亮正在梳头发，梳出来的是银亮的细雨。月亮问：“你冷不冷？”棉被说：“我身上有一百只风铃，风一吹就唱歌，一点都不冷。”",
  "它继续飞，飞到一片会翻跟头的田上。田里的玉米把自己的胡须编成辫子，招呼它下来喝水。棉被就在田边歇了一会儿，让玉米们钻进来取暖。",
  "天快亮的时候，棉被遇见了一只会写信的鲸鱼。鲸鱼住在很高的云海里，它说：“帮我捎一封信给海里的妈妈吧。”于是棉被把信缝进自己的棉花里，飞过了七座山。",
  "太阳出来时，棉被的边角有点化开了。它赶紧往回飞，一路上收拢所有跑偏的风铃，把每一只会打喷嚏的棉花都抱紧。",
  "天刚蒙蒙亮，棉被悄悄落回小满的床上，重新盖好，还替她把踢开的脚丫子收进被窝。小满醒来时，只闻到一股云和雨的味道，还有一点点海风。",
  "她抱住被子小声问：“你去哪儿啦？”被子里的一百只小风铃轻轻响了一下，像在说：“去了很远的地方，给你带回来一整个早晨。”",
].join("\n");
...
function chatResponse(prompt: string, hasImage: boolean, allText = ""): string {
  ...
  // 故事生成
  if (mode === "longstory") return LONG_STORY;
  return [
    "《小水滴的旅行》",
    "",
    "从前有一滴小水珠，住在一朵白云里。",
